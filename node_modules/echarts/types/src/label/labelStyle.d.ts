...
import { LabelOption, DisplayState, TextCommonOption, StatesOptionMixin, DisplayStateNonNormal, ColorString, ZRStyleProps, AnimationOptionMixin, InterpolatableValue, SeriesDataType } from '../util/types';
...
export declare function enableLayoutLayoutFeatures(el: Element, dataIndex: number, dataType: SeriesDataType): void;
